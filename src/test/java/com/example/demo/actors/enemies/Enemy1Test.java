...
class Enemy1Test extends ApplicationTest {

    private Enemy1 enemy;

    @BeforeEach
    void setUp() {
        Platform.runLater(() -> enemy = new Enemy1(100, 100));
        waitForFxEvents();
    }
    ...
    void testFireProjectile() {
        Platform.runLater(() -> {
            ...
            if (projectile != null) {
                assertTrue(projectile instanceof EnemyRocketProjectile, "The projectile should be an instance of EnemyRocketProjectile");
